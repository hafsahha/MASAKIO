...
class ForumDetailPage extends StatelessWidget {
      ...
      body: ListView(
        children: [
          ...
          _buildReply(
            ...
            content: 'Interesting Nicola that not one reply or tag on this #UX tweet shout out in the 24hrs since your tweet here......👌',
            timeAgo: '2d',
            replyingTo: '@karennne',
            retweetsCount: 1,
            likesCount: 1,
          ...
          _buildReply(
            ...
            content: 'Maybe I forgot the hashtags',
            timeAgo: '2d',
  ...
  void showReplyBottomSheet(BuildContext context, String originalMessage) {
    showModalBottomSheet(
      ...
      builder: (_) => ReplyBottomSheet(originalMessage: originalMessage),
    );
  }
